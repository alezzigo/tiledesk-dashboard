...
import { UserInputResultsComponent } from './view.component';
...
describe('PanoramicaComponent', () => {
  let component: UserInputResultsComponent;
  let fixture: ComponentFixture<UserInputResultsComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ UserInputResultsComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(UserInputResultsComponent);
